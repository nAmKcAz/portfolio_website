  ...
  return (
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white p-8">
      ...
      <div className="max-w-240 mx-auto grid grid-cols-7">
            ...
            <div className="developer-title col-start-2 col-span-5 text-1xl font-semibold mb-4">Senior Software Engineer | Systems, Gameplay & Networking</div>
            <div className="developer-description col-start-2 col-span-5 text-gray-400 text-sm mb-4">From backend APIs and databases, to 3rd party system integrations, to gameplay systems and objects, to Netcode, to performance and frametime tuning, to React UIs, a dash of AI and Computer Vision analysis, and even some CI, cloud infrastructure, and deployment; fullstack in the truest sense of the word.</div>
